...
MAPbBr3_Cubic_CHNPbXdata0 = []
MAPbBr3_Cubic_CHNPbXdata1 = []
for i in range(501, 1001):
    try:
        MAPbBr3_Cubic_CHNPbXdata0.append(np.load("./MAPbBr3_Cubic_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d0.npy".format(i), allow_pickle=True))
        MAPbBr3_Cubic_CHNPbXdata1.append(np.load("./MAPbBr3_Cubic_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d1.npy".format(i), allow_pickle=True))
    except Exception as e: print(e)

MAPbCl3_Cubic_CHNPbXdata0 = []
MAPbCl3_Cubic_CHNPbXdata1 = []
for i in range(501, 1001):
    try:
        MAPbCl3_Cubic_CHNPbXdata0.append(np.load("./MAPbCl3_Cubic_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d0.npy".format(i), allow_pickle=True))
        MAPbCl3_Cubic_CHNPbXdata1.append(np.load("./MAPbCl3_Cubic_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d1.npy".format(i), allow_pickle=True))
    except Exception as e: print(e)

MAPbI3_Cubic_CHNPbXdata0 = []
MAPbI3_Cubic_CHNPbXdata1 = []
for i in range(501, 1001):
    try:
        MAPbI3_Cubic_CHNPbXdata0.append(np.load("./MAPbI3_Cubic_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d0.npy".format(i), allow_pickle=True))
        MAPbI3_Cubic_CHNPbXdata1.append(np.load("./MAPbI3_Cubic_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d1.npy".format(i), allow_pickle=True))
    except Exception as e: print(e)

MAPbBr3_Ortho_CHNPbXdata0 = []
MAPbBr3_Ortho_CHNPbXdata1 = []
for i in range(501, 1001):
    try:
        MAPbBr3_Ortho_CHNPbXdata0.append(np.load("./MAPbBr3_Orthorhombic_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d0.npy".format(i), allow_pickle=True))
        MAPbBr3_Ortho_CHNPbXdata1.append(np.load("./MAPbBr3_Orthorhombic_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d1.npy".format(i), allow_pickle=True))
    except Exception as e: print(e)

MAPbCl3_Ortho_CHNPbXdata0 = []
MAPbCl3_Ortho_CHNPbXdata1 = []
for i in range(501, 1001):
    try:
        MAPbCl3_Ortho_CHNPbXdata0.append(np.load("./MAPbCl3_Orthorhombic_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d0.npy".format(i), allow_pickle=True))
        MAPbCl3_Ortho_CHNPbXdata1.append(np.load("./MAPbCl3_Orthorhombic_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d1.npy".format(i), allow_pickle=True))
    except Exception as e: print(e)

MAPbI3_Ortho_CHNPbXdata0 = []
MAPbI3_Ortho_CHNPbXdata1 = []
for i in range(501, 1001):
    try:
        MAPbI3_Ortho_CHNPbXdata0.append(np.load("./MAPbI3_Orthorhombic_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d0.npy".format(i), allow_pickle=True))
        MAPbI3_Ortho_CHNPbXdata1.append(np.load("./MAPbI3_Orthorhombic_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d1.npy".format(i), allow_pickle=True))
    except Exception as e: print(e)

MAPbBr3_Tetra_CHNPbXdata0 = []
MAPbBr3_Tetra_CHNPbXdata1 = []
for i in range(501, 1001):
    try:
        MAPbBr3_Tetra_CHNPbXdata0.append(np.load("./MAPbBr3_Tetragonal_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d0.npy".format(i), allow_pickle=True))
        MAPbBr3_Tetra_CHNPbXdata1.append(np.load("./MAPbBr3_Tetragonal_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d1.npy".format(i), allow_pickle=True))
    except Exception as e: print(e)

MAPbCl3_Tetra_CHNPbXdata0 = []
MAPbCl3_Tetra_CHNPbXdata1 = []
for i in range(501, 1001):
    try:
        MAPbCl3_Tetra_CHNPbXdata0.append(np.load("./MAPbCl3_Tetragonal_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d0.npy".format(i), allow_pickle=True))
        MAPbCl3_Tetra_CHNPbXdata1.append(np.load("./MAPbCl3_Tetragonal_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d1.npy".format(i), allow_pickle=True))
    except Exception as e: print(e)

MAPbI3_Tetra_CHNPbXdata0 = []
MAPbI3_Tetra_CHNPbXdata1 = []
for i in range(501, 1001):
    try:
        MAPbI3_Tetra_CHNPbXdata0.append(np.load("./MAPbI3_Tetragonal_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d0.npy".format(i), allow_pickle=True))
        MAPbI3_Tetra_CHNPbXdata1.append(np.load("./MAPbI3_Tetragonal_CHNPbX_data/CHNPbX_atmlist_L5_f{}_d1.npy".format(i), allow_pickle=True))
    except Exception as e: print(e)
...
for a in ['Br', 'Cl', 'I']:
    for b in ['Cubic', 'Ortho', 'Tetra']:
        ...
        print(np.shape(vars()["MAPb{}3_{}_CHNPbXdata0".format(a,b)]))
        print(np.shape(vars()["MAPb{}3_{}_CHNPbXdata1".format(a,b)]))
...
for a in ['Br', 'Cl', 'I']:
    for b in ['Cubic', 'Ortho', 'Tetra']:
        ...
        for i in range(len(vars()["MAPb{}3_{}_CHNPbXdata0".format(a,b)])):
            feat0 = []
            for j in range(len(vars()["MAPb{}3_{}_CHNPbXdata0".format(a,b)][i])):
                feat0.append(compute_stat(vars()["MAPb{}3_{}_CHNPbXdata0".format(a,b)][i][j]))
            #a_feat.append(feat)
            dirac0.append(feat0)

        for i in range(len(vars()["MAPb{}3_{}_CHNPbXdata1".format(a,b)])):
            feat1 = []
            for j in range(len(vars()["MAPb{}3_{}_CHNPbXdata1".format(a,b)][i])):
                feat1.append(compute_stat(vars()["MAPb{}3_{}_CHNPbXdata1".format(a,b)][i][j]))
            #a_feat.append(feat)
            dirac1.append(feat1)
...
dirac0 = np.reshape(dirac0, (4500, 23*12))
dirac1 = np.reshape(dirac1, (4500, 23*12))
dirac_feat = np.concatenate((dirac_feat0, dirac_feat1, dirac0, dirac1), axis=1)
print(np.shape(dirac_feat))
#print((dirac_feat[0]==dirac_feat[1]).all())

np.save("dirac_CNPbX_feat_d0.npy", dirac_feat0)
np.save("dirac_CNPbX_feat_d1.npy", dirac_feat1)
np.save("dirac_CHNPbX_feat_d0.npy", dirac0)
np.save("dirac_CHNPbX_feat_d1.npy", dirac1)
...
plt.xticks([])
plt.yticks([])
plt.savefig("MAPbX3_Classification_all_tSNE.png", dpi=200)
#plt.show()
